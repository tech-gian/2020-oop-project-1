...
### Documentation
    ...
    το που χρησιμεύει η καθεμία.Ακόμα, σε αυτό το .h αρχείο υπάρχουν κι οι συναρτήσεις
    που χρησιμοποιούνται από την καθεμία. Στο αρχείο classes.cc υπάρχουν οι υλοποιήσεις
    ...
    Στην main (στο αρχείο main.cc) δημιουργούνται μαθητές που ανήκουν σε K τμήματα (προέρχονται από
    ...
    [Η εντολή μεταγλώττισης: g++ -o main classes.cc main.cc
    και η εντολή για να τρέξει: ./main < 3 10 0.3 0.7 < input.txt]
